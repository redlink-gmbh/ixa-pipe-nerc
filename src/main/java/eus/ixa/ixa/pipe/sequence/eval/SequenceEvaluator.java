 ...
 * @see NameSample
 */
public class SequenceEvaluator extends Evaluator<NameSample> {
   ...
   */
  public SequenceEvaluator(TokenNameFinder nameFinder, TokenNameFinderEvaluationMonitor ... listeners) {
    super(listeners);
  ...
  protected NameSample processSample(NameSample reference) {
    ...
    String[] predictedTags = StringUtils.getTagsFromSpan(predictedNames, reference.getSentence());
    String[] referenceTags = StringUtils.getTagsFromSpan(references, reference.getSentence());
